...
public class NativeJavaModuleObject {
     ...
     */
    public static Object create(ScriptEngine engine, AppContext ctx, DynamicClassloader classloader, File file, Properties properties) throws IOException, ScriptException {

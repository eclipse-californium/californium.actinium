...
public class ModuleTest extends BaseServerTest {
	...
	public void testModule() throws InterruptedException, FileNotFoundException {
		installLibrary("test_js", new File("run/appserver/libs/test_js.js"));
		installScript("test_module", new File("run/appserver/installed/test_module.js"));
		...
		assertEquals("test_js", counterString);
